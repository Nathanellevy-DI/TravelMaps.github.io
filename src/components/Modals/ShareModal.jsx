 ...
 *
 * Modal for sharing a pin or category with one or more friends.
 * Loads the user's friends list. Each friend can be selected/deselected.
 * On submit, calls the shareService to share via the backend API.
 *
 * Note: This feature requires a backend to function. Without one,
 * the friends list will be empty and sharing will fail gracefully.
 *
 * @param {Object}   props
